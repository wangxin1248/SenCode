package com.wangxin1248.sensor.networks;
...
import com.wangxin1248.sensor.bean.FileEntity;
 ...
 * 自定义文件上传类
 */
public class MyMultipartRequest extends Request<String> {
    ...
    public MyMultipartRequest(String url, Map<String, String> params, Charset charSet, List<FileEntity> fileEntityList, Response.Listener<String> listener, Response.ErrorListener errorListener) {
    ...
    public MyMultipartRequest(String url, Map<String, String> params, Charset charSet, FileEntity fileEntity, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Method.POST, url, errorListener);
        this.mParams = params;
        this.mCharSet = charSet;
    ...
    public MyMultipartRequest(String url, Map<String, String> params, List<FileEntity> fileEntityList, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        this(url, params, Charset.defaultCharset(), fileEntityList, listener, errorListener);
    }

    public MyMultipartRequest(String url, Map<String, String> params, FileEntity fileEntity, Response.Listener<String> listener, Response.ErrorListener errorListener) {
